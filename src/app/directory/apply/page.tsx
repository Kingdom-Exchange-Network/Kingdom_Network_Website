    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-navy pt-28 pb-12 border-b border-gold/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="display-heading text-5xl mb-4">List Your Organization</h1>
          <p className="font-body text-cream/50">
            Apply to have your organization listed in the Kingdom Exchange Mission Network directory.
            All applications are reviewed and vetted before approval.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-navy-light border border-gold/15 p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label className="section-label block mb-2">Organization Name *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="section-label block mb-2">Contact Email *</label>
                <input
                  type="email"
              ...
              <div>
                <label className="section-label block mb-2">Primary Region *</label>
                <select className="w-full bg-navy border border-gold/20 px-3 py-2.5 font-body text-sm text-cream/70 outline-none focus:border-gold/50 transition-colors">
            ...
            <div>
              <label className="section-label block mb-2">Short Description * (1–2 sentences)</label>
              <textarea
                rows={2}
            ...
            <div>
              <label className="section-label block mb-2">Full Description *</label>
              <textarea
                rows={5}
            ...
            {/* Needs checkboxes */}
            <div>
              <label className="section-label block mb-3">Current Needs (check all that apply)</label>
              <div className="flex flex-wrap gap-4">
                {["Now Hiring", "Seeking Volunteers", "Accepting Donations"].map((need) => (
                  <label key={need} className="flex items-center gap-2 cursor-pointer">
                    <div className="w-4 h-4 border border-gold/30 bg-navy" />
                    <span className="font-body text-sm text-cream/60">{need}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            {/* 501c3 */}
            <div>
              <label className="section-label block mb-2">501(c)(3) or Registration Number (if applicable)</label>
              <input
                type="text"
            ...
            <div className="border-t border-gold/10 pt-6">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="font-body text-xs text-cream/50 leading-relaxed">
                  ...
                  <Link href="/about#disclaimer" className="text-gold/60 hover:text-gold transition-colors">
                    Kingdom Exchange Mission Network Liability Disclaimer
                  </Link>
                  . I understand this listing will be reviewed before publication.
                </span>
              </label>
            </div>
          ...
          <p className="font-body text-xs text-cream/30 mt-6 leading-relaxed">
            Applications are typically reviewed within 5–10 business days. You will receive an email
            confirmation when your listing is approved.{" "}
            <Link href="/about#vetting" className="hover:text-gold/50 transition-colors">
